...
#borrar todas las carpetas de plugins excepto interfaces
rm -R ./sources/plugins/dashboard-engine
rm -R ./sources/plugins/keycloak-ge
rm -R ./sources/plugins/keycloak-healthcare
rm -R ./sources/plugins/keycloak-onesaitplatform
rm -R ./sources/plugins/oauth-google
rm -R ./sources/plugins/oauth-server
...
#Borrar todas las carpetas de tools excepto Dashboard
rm -R ./tools/cas-overlay-template-5.2
rm -R ./tools/DataflowFront
rm -R ./tools/DataflowOnesaitPlatformNode
rm -R ./tools/DataflowOrchestratorLib
rm -R ./tools/Eclipse-plugin
rm -R ./tools/Flow-Engine-Manager
rm -R ./tools/graylog-onesaitplatform-authenticator
rm -R ./tools/keycloak
rm -R ./tools/onesait-platform-interpreter
rm -R ./tools/onesait-platform-zeppelin-authenticator
rm -R ./tools/OpenRefine
rm -R ./tools/sql-to-mongo-db-query-converter
...
rm -R ./sources/modules/control-panel/src/main/java/com/minsait/onesait/platform/controlpanel/controller/opendata/TypologyController.java
...
rm -R ./sources/services/business-services/src/main/java/com/minsait/onesait/platform/business/services/resources
rm -R ./sources/modules/control-panel/src/main/java/com/minsait/onesait/platform/controlpanel/rest/management/opendata

echo "Remove OpenData files...............OK"

echo "Remove Datacleaner files"

rm -R ./sources/modules/control-panel/src/main/java/com/minsait/onesait/platform/controlpanel/controller/openrefine

echo "Remove Datacleaner files...............OK"

echo "Remove Keycloak files"

rm -R ./sources/modules/control-panel/src/main/java/com/minsait/onesait/platform/controlpanel/controller/keycloak
rm -R ./sources/modules/control-panel/src/main/java/com/minsait/onesait/platform/controlpanel/services/keycloak

echo "Remove Keycloak files...............OK"

echo "Remove Datarefiner files"

rm -R ./sources/modules/control-panel/src/main/java/com/minsait/onesait/platform/controlpanel/services/datarefiner
rm -R ./sources/modules/control-panel/src/main/java/com/minsait/onesait/platform/controlpanel/rest/management/datarefiner

echo "Remove Datarefiner files...............OK"

echo "Remove LogCentralizer files"

rm -R ./sources/modules/control-panel/src/main/java/com/minsait/onesait/platform/controlpanel/controller/logcentralizer

echo "Remove LogCentralizer files...............OK"

echo "Remove Edge files"

rm -R ./sources/modules/control-panel/src/main/java/com/minsait/onesait/platform/controlpanel/controller/edge

echo "Remove Edge files...............OK"
