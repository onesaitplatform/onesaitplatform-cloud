...
public enum OpenAIModel {
	GPT_4("gpt-4", 25000, true),
    GPT_TURBO("gpt-3.5-turbo", 4096, true),
    GPT_TURBO_16K("gpt-3.5-turbo-16k", 16384, true),
    ...
    public static OpenAIModel getByName(String name) {
        Optional<OpenAIModel> model = Arrays.stream(values()).filter(it -> it.name.equals(name)).findFirst();
