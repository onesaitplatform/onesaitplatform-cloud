 ...
 */
package com.minsait.onesait.platform.business.services.api.swagger;
...
public class RestSwaggerReader {
	...
	private static final String AUTHENTICATION_HEADER = "X-OP-APIKey";
...
//		schemes.add(Scheme.HTTP);
	...
	private void parse(Swagger swagger, OperacionDTO operacionDTO) {
		...
		createPARAMETER(swagger, op, AUTHENTICATION_HEADER, AUTHENTICATION_HEADER,
