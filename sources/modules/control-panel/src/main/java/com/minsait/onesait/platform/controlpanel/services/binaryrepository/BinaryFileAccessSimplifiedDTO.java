...
@NoArgsConstructor
@AllArgsConstructor
public class BinaryFileAccessSimplifiedDTO {
	...
	public BinaryFileAccessSimplifiedDTO(BinaryFileAccess binaryFileAccess) {
		userId = binaryFileAccess.getUser().getUserId();
		accessType = binaryFileAccess.getAccessType().name();
	}
