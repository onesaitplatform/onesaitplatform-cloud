...
@NoArgsConstructor
@AllArgsConstructor
public class OntologyTimeSeriesPropertyDTO {
	...
	public OntologyTimeSeriesPropertyDTO(OntologyTimeSeriesProperty property) {
		this.propertyDataType = property.getPropertyDataType();
