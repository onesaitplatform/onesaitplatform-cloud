...
@Controller
@RequestMapping("versioning/ie")
@Slf4j
public class VersioningIEController {
	...
	public Object generateBundle(@RequestParam(name = "folderName", required = true) String folderName,
		...
		if (StringUtils.hasText(inclusionsString)) {
			...
			if (!StringUtils.hasText(folderName)) {
				...
				return "redirect:/versioning/export";
			}
			...
			if (generateZip) {
				try {
					...
					return "redirect:/versioning/ie/export";
				}
			} else {
