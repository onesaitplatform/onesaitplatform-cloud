...
@NoArgsConstructor
@AllArgsConstructor
public class OntologyTimeSeriesDTO extends OntologyDTO {

	@NotNull
	@Getter
	@Setter
	private List<OntologyTimeSeriesWindowDTO> windows;
	...
	public static List<OntologyTimeSeriesWindowDTO> windowdsToWindowsDTO(Set<OntologyTimeSeriesWindow> windows) {
		List<OntologyTimeSeriesWindowDTO> windowsDTO = new ArrayList<>();
		for (OntologyTimeSeriesWindow window: windows) {
			windowsDTO.add(new OntologyTimeSeriesWindowDTO(window));
		}
		return windowsDTO;
	}
	
	public static List<OntologyTimeSeriesPropertyDTO> propertiesToPropertiesDTO(Set<OntologyTimeSeriesProperty> properties) {
		List<OntologyTimeSeriesPropertyDTO> propertiesDTO = new ArrayList<>();
		for (OntologyTimeSeriesProperty property: properties) {
