...
public class OpenDataOntologyResourceResponseDTO extends OpenDataResourceResponseDTO{
	...
	public OpenDataOntologyResourceResponseDTO(OpenDataResource o, DatasetResource od, OpenDataPackage d) {
		super(o, d);
		this.ontology = od.getIdentification();
		this.query = od.getQuery();
	}
