...
public class UserApiSimplifiedInputDTO implements Serializable {
	...
	public UserApiSimplifiedInputDTO() {

	}

	public UserApiSimplifiedInputDTO(UserApi userApi) {
		this.userId = userApi.getUser().getUserId();
	}
	
	public UserApiSimplifiedInputDTO(UserApiDTO userApiDto) {
