...
public class UserApiSimplifiedResponseDTO implements Serializable {
	...
	public UserApiSimplifiedResponseDTO() {

	}

	public UserApiSimplifiedResponseDTO(UserApi userApi) {
	...
	public UserApiSimplifiedResponseDTO(UserApiDTO userApiDto) {
		this.userId = userApiDto.getUserId();
		this.apiIdentification = userApiDto.getApiIdentification();
		this.apiVersion = userApiDto.getApiVersion();
	}
