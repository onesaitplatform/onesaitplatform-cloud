              ...
              <el-form :inline="true" size="mini">
                ...
                <el-form-item label="Title">
                 ...
                 <el-form-item label="Description">
                  <el-input placeholder="Description" type="textarea" :rows="1" v-model='element.desc' ></el-input>
                </el-form-item>
                ...
                <span v-if="!element.elements">
                  ...
                  <span v-if="element.type == 'datasource-picker'"><!-- datasource-picker only -->
                    <!--<el-form-item>
                    </el-form-item>-->
                  </span>
                </span>
...
Vue.component('gform-drawer', {
  ...
  methods: {
    ...
    updateElem: function(key, value) {
      ...
      this.$emit('input', this.getRealValue())
      this.$forceUpdate()
      window.dispatchEvent(new CustomEvent("ChangeParam",{
		detail: {
    ...
    updateDSFields() {
      ...
      this.$emit('input', this.getRealValue())
      this.getDatasourceFields()
      window.dispatchEvent(new CustomEvent("ChangeMainDatasource",{
		  detail: this.localdatasource
	  }));
    },
