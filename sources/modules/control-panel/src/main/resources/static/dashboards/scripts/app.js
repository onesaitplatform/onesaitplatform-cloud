        ...
        $scope.save = function() {
          if(!edit){
            ...
            if($scope.config.template){// ID mode, save init params (edit only params)
              ...
              $scope.config.content=utilsService.parseProperties($scope.config.content);         
              $scope.config.contentcode=utilsService.parseProperties($scope.config.contentcode,true);
            }
...
(function () {
  ...
  MainController.$inject = ["$window", "$rootScope", "$scope", "$mdDialog", "$timeout", "httpService", "interactionService", "urlParamService", "gadgetManagerService", "filterService", "utilsService", "$translate", "localStorageService", "__env", "cacheBoard"];
  angular.module('dashboardFramework')
    .component('dashboard', {
  ...
  /** @ngInject */
  function MainController($window, $rootScope, $scope,  $mdDialog, $timeout,  httpService, interactionService,urlParamService, gadgetManagerService,filterService,utilsService, $translate, localStorageService, __env, cacheBoard) {
    var vm = this;
    vm.$onInit = function () {
