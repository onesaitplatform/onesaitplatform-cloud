var GraphController = function() {
	...
	var createSvgCluster = function(group,idSource){
		...
		svgCluster += '<svg xmlns="http://www.w3.org/2000/svg" width="'+ calculateClusterTextWidth(group,font) +'" height="60">'+
				'<rect x="0" y="0" width="100%" rx="4" ry="4" height="100%" fill="#FFFFFF"  stroke="#D7DADC" style="stroke-width:3" ></rect>'+
				'<foreignObject x="12" y="12" width="100%" height="100%">'+
					'<div xmlns="http://www.w3.org/1999/xhtml">'+						
						...
						'<span style="text-align: center; position: absolute; font-family: Soho,Arial; font-size:12px; color:#505D66; top:1px; left: '+ counter +'px;font-weight: bolder">' + parseInt(network.getConnectedNodes(idSource,'to').length) + '</span>'+
						'<span style="position: absolute; text-align: center; font-family: Soho,Arial; font-size:12px; color:#505D66; top:20px;  left: 12px;font-weight: bolder">'+ group.capitalize() +'</span>'+						
					'</div>'+
			    '</foreignObject>'+
			'</svg>';
	...
	var getDataGraph = function() {
		...
		var createSvg = function(title,font,group){
			...
			var groupIcon = {
				...
				"user":'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.24923 7.47906C5.37645 6.90757 4.7999 5.92111 4.7999 4.79998C4.7999 3.03266 6.23259 1.59998 7.9999 1.59998C9.76721 1.59998 11.1999 3.03266 11.1999 4.79998C11.1999 5.92111 10.6234 6.90757 9.75057 7.47906C11.986 8.21412 13.5999 10.3186 13.5999 12.8C13.5999 15.2 2.3999 15.2 2.3999 12.8C2.3999 10.3186 4.01383 8.21412 6.24923 7.47906ZM12.7999 12.7999C12.7999 10.1489 10.6508 7.99988 7.99988 7.99988C5.34891 7.99988 3.19988 10.1489 3.19988 12.7999C3.19988 13.1905 5.3326 13.7999 7.99988 13.7999C10.6672 13.7999 12.7999 13.1905 12.7999 12.7999ZM7.99988 7.19988C9.32536 7.19988 10.3999 6.12536 10.3999 4.79988C10.3999 3.47439 9.32536 2.39988 7.99988 2.39988C6.67439 2.39988 5.59988 3.47439 5.59988 4.79988C5.59988 6.12536 6.67439 7.19988 7.99988 7.19988Z" fill="#1168A6"/></svg>',
