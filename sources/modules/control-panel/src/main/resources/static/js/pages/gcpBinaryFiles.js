var BinaryFilesController = function() {
	var mainPath = '/controlpanel/files/gcp/';
	var publicPath = '/controlpanel/files/gcp/public';
	var listPath = '/controlpanel/files/gcp';
	...
	var authorization = function(action,file,user,accesstype,authorization,btn){
		...
		var insertURL = '/controlpanel/files/gcp/authorization';
		var updateURL = '/controlpanel/files/gcp/authorization/update';
		var deleteURL = '/controlpanel/files/gcp/authorization/delete';
		var response = {};
