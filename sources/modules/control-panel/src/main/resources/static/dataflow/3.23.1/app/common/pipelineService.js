...
angular.module('dataCollectorApp.common')
  .service('pipelineService', ["authService", "pipelineConstant", "api", "$q", "$translate", "$modal", "$location", "$route", "_", function(authService, pipelineConstant, api, $q, $translate, $modal, $location, $route, _) {
