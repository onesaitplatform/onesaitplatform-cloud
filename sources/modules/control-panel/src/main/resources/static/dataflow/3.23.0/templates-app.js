...
angular.module("app/help/inspectors/inspectors.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/help/inspectors/inspectors.tpl.html",
...
angular.module("app/help/register/registrationPermissionErrorModal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/help/register/registrationPermissionErrorModal.tpl.html",
    "<div class=\"modal-header\">\n" +
    "  <h3 class=\"modal-title\">Activation Required</h3>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "  <p>\n" +
    "    Activation must be performed by a Data Collector administrator. This account does\n" +
    "    not have the Admin role. Please log in as a Data Collector administrator, or\n" +
    "    contact your Data Collector administrator to have them activate this Data\n" +
    "    Collector instance.\n" +
    "  </p>\n" +
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "  <button type=\"button\" class=\"btn btn-default\"\n" +
    "    ng-click=\"common.logout()\">Log Out</button>\n" +
    "</div>\n" +
    "");
}]);
...
angular.module("app/help/settings/settingsModal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/help/settings/settingsModal.tpl.html",
    ...
    "    <div class=\"checkbox\">\n" +
    "      <label>\n" +
    "        <input type=\"checkbox\" ng-model=\"$storage.dontShowMissingStages\"> {{'sdcSettings.dontShowMissingStages' | translate}}\n" +
    "      </label>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"checkbox\">\n" +
...
angular.module("app/home/detail/configuration/groupConfiguration.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/detail/configuration/groupConfiguration.tpl.html",
    ...
    "\n" +
    "    <div ng-switch-when=\"VALUE_CHOOSER\" ng-if=\"!configDefinition.connectionType\">\n" +
    "      <ng-include src=\"'labelConfigurationTemplate'\"></ng-include>\n" +
...
angular.module("app/home/detail/detail.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/detail/detail.tpl.html",
    ...
    "        && hasAdvancedConfig(detailPaneConfigDefn.configDefinitions, detailPaneServices)\">\n" +
    "        <label\n" +
...
angular.module("app/home/detail/summary/summary.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/detail/summary/summary.tpl.html",
    ...
    "\n" +
    "  <div class=\"row\" ng-if=\"runHistory.length > 0 && (!isPipelineRunning || selectedRunHistory !== runHistory[0]) && selectedRunHistory\">\n" +
    ...
    "      <tbody ng-hide=\"showLoading\">\n" +
    "      <tr>\n" +
    "        <td>{{selectedRunHistory.appName}}</td>\n" +
    "        <td>{{selectedRunHistory.started | date:'medium'}}</td>\n" +
    "        <td>{{selectedRunHistory.completed | date:'medium'}}</td>\n" +
    "        <td>{{selectedRunHistory.completed | amDifference : selectedRunHistory.started | amDurationFormat }} </td>\n" +
    "        <td>{{selectedRunHistory.user}}</td>\n" +
    "        <td>{{selectedRunHistory.status}}</td>\n" +
    "      </tr>\n" +
    "      </tbody>\n" +
    "    </table>\n" +
    "\n" +
    "    <div class=\"alert alert-danger\" role=\"alert\" ng-if=\"selectedRunHistory.status !== 'STOPPED' && selectedRunHistory.message\">\n" +
    "      <i class=\"fa fa-exclamation-triangle\"></i>\n" +
    "      <span>Pipeline Status: {{selectedRunHistory.status}}: {{selectedRunHistory.message}}</span>\n" +
    "    </div>\n" +
    "\n" +
    "  </div>\n" +
    "\n" +
    ...
    "  </div>\n" +
    "\n" +
    "  <div class=\"row\" ng-if=\"restServiceAPIEndpoint\">\n" +
    "    <div class=\"col-sm-12 col-md-12 col-lg-12\">\n" +
    "      <div class=\"alert alert-info\" role=\"alert\">\n" +
    "        <span>REST Service API Endpoint - </span>\n" +
    "        <a ng-href=\"{{restServiceAPIEndpoint}}\" target=\"_blank\">{{restServiceAPIEndpoint}}</a>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "\n" +
    ...
    "        <div class=\"panel-body\">\n" +
    "          <ul class=\"table-properties\">\n" +
    "            <li ng-repeat= \"(propertyKey, propertyValue) in detailPaneMetrics.gauges[customStageGauge.gaugeKey].value\">\n" +
    ...
    "        </div>\n" +
    "        <div class=\"panel-body\">\n" +
    "          <ul class=\"table-properties\" ng-init=\"gaugeData = detailPaneMetrics.gauges[runnerGauge.gaugeKey].value\">\n" +
    "            <li>\n" +
    ...
    "              <span class=\"properties-value\">{{gaugeData.state}}</span>\n" +
    "            </li>\n" +
    "            <li ng-if=\"gaugeData.currentStage !== 'IDLE'\">\n" +
    ...
    "</div>\n" +
    "\n" +
    "<div class=\"alert alert-info\" role=\"alert\" ng-if=\"pipelineStateHistory.length > 0 && runHistory.length === 0\">\n" +
    "  <span>No Run History found</span>\n" +
    "</div>\n" +
    "\n" +
    ...
    "              <span class=\"properties-value\">{{detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.availableRunners}}/{{detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.totalRunners}}</span>\n" +
    "            </li>\n" +
    "          </ul>\n" +
    ...
    "        <ul class=\"table-properties\">\n" +
    "          <li>\n" +
    "            <span class=\"properties-label\">Current Stages:</span>\n" +
    "            <span class=\"properties-value\"\n" +
    "                  ng-repeat=\"currentStage in detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.currentStages\">{{stageNameToLabelMap[currentStage] + (!$last ? ', ' : '')}}</span>\n" +
    "            <span class=\"properties-value\"\n" +
    "                  ng-if=\"!detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.currentStages || detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.currentStages.length === 0\">--</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label last-batch\">{{'home.detailPane.summaryTab.lastBatchInputRecordsCount' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.lastBatchInputRecordsCount}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label last-batch\">{{'home.detailPane.summaryTab.lastBatchOutputRecordsCount' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.lastBatchOutputRecordsCount}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label last-batch\">{{'home.detailPane.summaryTab.lastBatchErrorRecordsCount' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.lastBatchErrorRecordsCount}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label last-batch\">{{'home.detailPane.summaryTab.lastBatchErrorMessagesCount' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.lastBatchErrorMessagesCount}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label\">{{'home.detailPane.summaryTab.timeOfLastReceivedRecord' | translate}}:</span>\n" +
    "            <span class=\"properties-value\"\n" +
    "                  ng-if=\"detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.timeOfLastReceivedRecord\"\n" +
    "              >{{detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.timeOfLastReceivedRecord  | date:'medium'}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label\">{{'home.detailPane.summaryTab.batchCount' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.batchCount}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label\">{{'home.detailPane.summaryTab.idleBatchCount' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['RuntimeStatsGauge.gauge'].value.idleBatchCount}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    ...
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['health.ProductionPipelineRunnable.gauge'].value.timestamp  | date:'medium'}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label\">{{'home.detailPane.summaryTab.rulesConfigLoaderRunnable' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['health.RulesConfigLoaderRunnable.gauge'].value.timestamp  | date:'medium'}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label\">{{'home.detailPane.summaryTab.dataObserverRunnable' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['health.DataObserverRunnable.gauge'].value.timestamp  | date:'medium'}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label\">{{'home.detailPane.summaryTab.metricObserverRunnable' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['health.MetricObserverRunnable.gauge'].value.timestamp  | date:'medium'}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "          <li>\n" +
    "            <span class=\"properties-label\">{{'home.detailPane.summaryTab.metricsEventRunnable' | translate}}:</span>\n" +
    "            <span class=\"properties-value\">{{detailPaneMetrics.gauges['health.MetricsEventRunnable.gauge'].value.timestamp  | date:'medium'}}</span>\n" +
    "          </li>\n" +
    "\n" +
    "        </ul>\n" +
    "\n" +
    ...
    "      <div class=\"panel-body\">\n" +
    "        <ul class=\"table-properties\">\n" +
    "          <li ng-repeat=\"sdcURL in detailPaneMetrics.slaves\">\n" +
    ...
    "              ng-if=\"!detailPaneMetrics || !detailPaneMetrics.slaves || detailPaneMetrics.slaves.length === 0\"\n" +
...
angular.module("app/home/header/header.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/header/header.tpl.html",
    ...
    "    </div>\n" +
    "\n" +
    "    <!-- Only for Sample Pipeline -->\n" +
    "    <div class=\"pull-right sample-pipeline-duplicate\" ng-if=\"pipelineConfig && isSamplePipeline\">\n" +
    "\n" +
    "      <a ng-if=\"tutorialLink\" class=\"btn\"\n" +
    "         ng-href=\"{{tutorialLink}}\" target=\"_blank\"\n" +
    "         ng-click=\"trackTutorialLinkClicked(pipelineConfig)\">\n" +
    "        <i class=\"fa fa-book\"></i>\n" +
    "        <span>Tutorial</span>\n" +
    "      </a>\n" +
    "\n" +
    "      <a class=\"btn btn-primary\"\n" +
    "         ng-click=\"duplicatePipelineConfig(activeConfigInfo, $event)\">\n" +
    "        <i class=\"fa fa-files-o\"></i>\n" +
    "        <span>{{'global.form.duplicate' | translate}}</span>\n" +
    "      </a>\n" +
    "    </div>\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"pull-left\" ng-if=\"pipelineConfig && isSamplePipeline\">\n" +
    "      <div class=\"panel-title pull-left\">\n" +
    "        <span class=\"pipeline-status SAMPLE_PIPELINE\">Sample Pipeline</span>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "\n" +
    "  </div>\n" +
...
angular.module("app/home/home_list_view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/home_list_view.tpl.html",
    ...
    "        </span>\n" +
    "\n" +
    "        <span class=\"pipeline-creator\" ng-if=\"selectedPipelineLabel !== 'system:samplePipelines'\">{{pipeline.creator}}</span>\n" +
    "\n" +
    ...
    "              ng-if=\"selectedPipelineLabel !== 'system:samplePipelines'\"\n" +
    "              ng-show=\"common.pipelineStatusMap[pipeline.pipelineId].status === 'RUNNING'\">\n" +
    "          <span class=\"time-update\" translate=\"home.header.uptime\">Uptime</span>\n" +
    "          <span class=\"time-update\" am-time-ago=\"common.pipelineStatusMap[pipeline.pipelineId].timeStamp\"></span>\n" +
    "        </span>\n" +
    ...
    "          <a\n" +
    "            ng-if=\"pipeline.tutorialLink\"\n" +
    "            ng-href=\"{{pipeline.tutorialLink}}\" target=\"_blank\"\n" +
...
angular.module("app/home/home_no_activation.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/home_no_activation.tpl.html",
...
angular.module("app/home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/home.tpl.html",
    "<ng-include src=\"'app/home/home_no_activation.tpl.html'\"></ng-include>\n" +
    "\n" +
...
angular.module("app/home/library/duplicate/duplicate.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/library/duplicate/duplicate.tpl.html",
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"form-group\" ng-if=\"!isSamplePipeline\">\n" +
...
angular.module("app/home/library/sample_pipelines/samplePipelinesModal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/library/sample_pipelines/samplePipelinesModal.tpl.html",
    "<form class=\"sample-pipelines-modal-form\" role=\"form\">\n" +
    "  <div class=\"modal-header\">\n" +
    "    <button type=\"button\" class=\"close\" ng-click=\"close()\">\n" +
    "      <span aria-hidden=\"true\">&times;</span>\n" +
    "      <span class=\"sr-only\">Close</span>\n" +
    "    </button>\n" +
    "    <h3 class=\"modal-title\">Sample Pipelines</h3>\n" +
    "  </div>\n" +
    "  <div class=\"modal-body\">\n" +
    "\n" +
    "    <ng-include src=\"'app/home/alerts/error/errorAlert.tpl.html'\"></ng-include>\n" +
    ...
    "      </thead>\n" +
    "      <tbody>\n" +
    "      <tr ng-repeat=\"samplePipeline in samplePipelines\">\n" +
    "        <td>\n" +
    "          <a href=\"javascript:;\"\n" +
    "             ng-click=\"openSamplePipeline(samplePipeline)\" ><span>{{samplePipeline.title}}</span></a>\n" +
    "        </td>\n" +
    "        <td>\n" +
    "          <a\n" +
    "            ng-if=\"samplePipeline.tutorialLink\"\n" +
    "            ng-href=\"{{samplePipeline.tutorialLink}}\" target=\"_blank\"\n" +
    "            ng-click=\"trackTutorialLinkClicked(samplePipeline)\">Click to View</a>\n" +
    "        </td>\n" +
    "        <td>{{samplePipeline.origins}}</td>\n" +
    "        <td>{{samplePipeline.destinations}}</td>\n" +
    "      </tr>\n" +
    "\n" +
    "      <tr ng-if=\"remotePipelines.length === 0\">\n" +
    "        <td colspan=\"4\" class=\"no-records text-center\">No Pipelines to view.</td>\n" +
    "      </tr>\n" +
    "\n" +
    "      </tbody>\n" +
    "    </table>\n" +
...
angular.module("app/home/packageManager/install_missing_stage_library/install_missing_stage_library.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/packageManager/install_missing_stage_library/install_missing_stage_library.tpl.html",
    "<div class=\"modal-header\">\n" +
    ...
    "  </div>\n" +
    "\n" +
    "  <div ng-if=\"operationStatus !== 'complete' && operationStatus !== 'restarting'\">\n" +
    ...
    "              ng-options=\"item.libraryId as item.libraryLabel for item in missingStageInfo.libraryList | orderBy:'libraryLabel'\">\n" +
    "      </select>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "\n" +
...
angular.module("app/home/packageManager/package_manager.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/packageManager/package_manager.tpl.html",
    "<div class=\"panel panel-default page-panel package-manager-page fs-unmask\">\n" +
...
angular.module("app/home/pipelineHome/pipelineHome.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/pipelineHome/pipelineHome.tpl.html",
    ...
    "                   ng-class=\"{'hide-stage-library-panel': !pipelineConfig || $storage.hideStageLibraryPanel || $storage.maximizeDetailPane || isPipelineRunning || previewMode || snapshotMode || isSamplePipeline}\"\n" +
    "                   ng-cloak>\n" +
    "\n" +
    "        <bg-pane min-size=\"0\">\n" +
...
angular.module("app/home/stageLibrary/stageLibrary.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/stageLibrary/stageLibrary.tpl.html",
    "<div class=\"stage-library-pane fs-unmask\" ng-controller=\"StageLibraryController\">\n" +
    ...
    "            ng-class=\"{'not-installed': stageLibrary.notInstalled}\"\n" +
...
angular.module("app/home/usersAndGroups/changePassword/changePassword.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/usersAndGroups/changePassword/changePassword.tpl.html",
    "<div class=\"modal-header\">\n" +
    "  <button type=\"button\" class=\"close\" ng-click=\"cancel()\">\n" +
    "    <span aria-hidden=\"true\">&times;</span>\n" +
    "    <span class=\"sr-only\">Close</span>\n" +
    ...
    "        autofocus\n" +
    "        class=\"form-control\"\n" +
    "        ng-model=\"userModel.oldPwd\">\n" +
    "    <small ng-if=\"oldPwdError\" class=\"invalid\">{{oldPwdError}}</small>\n" +
    "  </div>\n" +
    "  <div class=\"form-group\">\n" +
    ...
    "        ng-disabled=\"{{ isCreateInProgress }}\"\n" +
    "        class=\"form-control\"\n" +
    "        ng-model=\"userModel.newPwd\">\n" +
    "    <small ng-if=\"newPwdError\" class=\"invalid\">{{newPwdError}}</small>\n" +
    "    <small class=\"form-text text-muted\">Password must be 6-12 characters, and must not contain spaces.</small>\n" +
    "  </div>\n" +
    "  <div class=\"form-group\">\n" +
    "    <label class=\"control-label\">New Password Verification</label>\n" +
    "    <input type=\"password\"\n" +
    "        autocomplete=\"new-password\"\n" +
    "        ng-disabled=\"{{ isCreateInProgress }}\"\n" +
    "        class=\"form-control\"\n" +
    "        ng-model=\"userModel.newPwdVerif\">\n" +
    "    <small ng-if=\"newPwdVerifError\" class=\"invalid\">{{newPwdVerifError}}</small>\n" +
...
angular.module("app/home/usersAndGroups/delete/delete.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/usersAndGroups/delete/delete.tpl.html",
    "<div class=\"modal-header\">\n" +
    "  <button type=\"button\" class=\"close\" ng-click=\"no()\">\n" +
    "    <span aria-hidden=\"true\">&times;</span>\n" +
    "    <span class=\"sr-only\">Close</span>\n" +
    ...
    "  <ng-include src=\"'app/home/alerts/error/errorAlert.tpl.html'\"></ng-include>\n" +
    "\n" +
    "  <div ng-if=\"isLastAdmin\">\n" +
    "    <p class=\"invalid\">\"{{userId}}\" is the only Administrator.</p>\n" +
    "    <p>If you really want to delete this administrator, you must create another one first.</p>\n" +
    "  </div>\n" +
    "\n" +
    "  <p ng-if=\"!isLastAdmin\">Are you sure you want to delete the user \"{{userId}}\"?</p>\n" +
    "\n" +
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "  <button type=\"button\" class=\"btn btn-default\" ng-click=\"no()\" ng-if=\"!operationInProgress\">{{isLastAdmin ? 'Close' : 'No'}}</button>\n" +
    "  <button type=\"button\" class=\"btn btn-primary\" ng-click=\"yes()\" ng-if=\"!(isLastAdmin || operationInProgress)\"\n" +
    "          translate=\"global.form.yes\">Yes</button>\n" +
    "  <button type=\"submit\" class=\"btn btn-primary\" ng-if=\"operationInProgress\" disabled\n" +
    "          translate=\"global.form.deleting\">Deleting...</button>\n" +
    "</div>\n" +
...
angular.module("app/home/usersAndGroups/userDetails/user.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/usersAndGroups/userDetails/user.tpl.html",
