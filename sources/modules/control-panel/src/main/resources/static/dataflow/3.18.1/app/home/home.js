...
angular
  ...
  .controller('HomeController', ["$scope", "$rootScope", "$routeParams", "$q", "$modal", "$location", "pipelineService", "api", "configuration", "pipelineConstant", "Analytics", "$route", "$translate", "tracking", "trackingEvent", function (
