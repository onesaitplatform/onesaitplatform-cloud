...
angular.module("app/help/register/registerModal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/help/register/registerModal.tpl.html",
    ...
    "  <div class=\"modal-header\">\n" +
    "    <button type=\"button\" class=\"close\" ng-click=\"cancel()\" ng-if=\"activationInfo.info.valid\">\n" +
    "      <span aria-hidden=\"true\">&times;</span>\n" +
    "      <span class=\"sr-only\">Close</span>\n" +
    "    </button>\n" +
    ...
    "            Log into StreamSets Account Management to activate.\n" +
    "          </p>\n" +
    "        </div>\n" +
    "        <div class=\"modal-footer\">\n" +
    "          <a class=\"btn btn-primary\" href=\"{{registerWithAccountUrl}}\" role=\"button\">Activate</a>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "      <div ng-if=\"!registerWithAccountUrl\">\n" +
    ...
    "      </div>\n" +
    "      <div class=\"modal-footer\">\n" +
    "        <button type=\"reset\" class=\"btn btn-default\" ng-click=\"goToRegistration()\" ng-hide=\"operationDone || operationInProgress\">\n" +
    "          Back\n" +
    "        </button>\n" +
    "        <button type=\"submit\" class=\"btn btn-primary\"\n" +
...
angular.module("app/help/register/registrationPermissionErrorModal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/help/register/registrationPermissionErrorModal.tpl.html",
    ...
    "<div class=\"modal-body\">\n" +
    "  <p>\n" +
    "    Using advanced stage libraries in Data Collector requires activating the product.\n" +
...
angular.module("app/home/home_grid_view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/home_grid_view.tpl.html",
    ...
    "    <header>\n" +
    "      <a target=\"_blank\" ng-href=\"{{'collector/pipeline/' + pipeline.pipelineId}}\">\n" +
...
angular.module("app/home/home_list_view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/home_list_view.tpl.html",
    ...
    "            ng-href=\"{{pipeline.tutorialLink}}\" target=\"_blank\">Click to View</a>\n" +
    "        </span>\n" +
    "\n" +
...
angular.module("app/home/library/sample_pipelines/samplePipelinesModal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/home/library/sample_pipelines/samplePipelinesModal.tpl.html",
    ...
    "            ng-href=\"{{samplePipeline.tutorialLink}}\" target=\"_blank\">Click to View</a>\n" +
    "        </td>\n" +
