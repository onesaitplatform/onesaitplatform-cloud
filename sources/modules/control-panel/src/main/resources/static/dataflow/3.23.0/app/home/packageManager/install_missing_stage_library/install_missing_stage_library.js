...
angular
  ...
  .controller('InstallMissingLibraryModalInstanceController',
      ["$scope", "$rootScope", "$modalInstance", "missingStageInfo", "libraryList", "withStageLibVersion", "api", "pipelineConstant", "$modal", "authService", function ($scope, $rootScope, $modalInstance, missingStageInfo, libraryList, withStageLibVersion, api,
