...
angular
  ...
  .controller('RegisterModalInstanceController', ["$scope", "$rootScope", "$modalInstance", "$location", "$interval", "$q", "api", "activationInfo", "configuration", "authService", "showKeyEntry", "activationTracking", "$httpParamSerializer", function (
