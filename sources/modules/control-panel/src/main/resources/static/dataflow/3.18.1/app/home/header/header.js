...
angular
  ...
  .controller('HeaderController', ["$scope", "$rootScope", "$timeout", "_", "api", "$translate", "$location", "authService", "pipelineService", "pipelineConstant", "$modal", "$q", "$route", "pipelineTracking", "tracking", "trackingEvent", function (
