...
angular.module('dataCollectorApp.common')
  .service('contextHelpService', ["$rootScope", "$q", "configuration", "api", "pipelineConstant", "pipelineService", "tracking", "trackingEvent", function($rootScope, $q, configuration, api, pipelineConstant, pipelineService,
