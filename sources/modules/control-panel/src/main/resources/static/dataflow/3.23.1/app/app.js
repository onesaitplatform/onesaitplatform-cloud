...
angular.module('dataCollectorApp')
  ...
  .run(["$location", "$rootScope", "$modal", "api", "pipelineConstant", "$localStorage", "contextHelpService", "$modalStack", "$timeout", "$translate", "authService", "userRoles", "configuration", "Analytics", "$q", "editableOptions", "$http", "tracking", "trackingEvent", function ($location, $rootScope, $modal, api, pipelineConstant, $localStorage, contextHelpService, $modalStack,
