...
angular.module('pipelineGraphDirectives', [])
  ...
  .controller('PipelineGraphController', ["$scope", "$rootScope", "$element", "_", "$filter", "$location", "$modal", "pipelineConstant", "$translate", "pipelineService", "pipelineTracking", function(
