...
angular
  ...
  .controller('DetailController', ["$scope", "$rootScope", "_", "pipelineConstant", "api", "contextHelpService", "$modal", "authService", "userRoles", "configuration", "pipelineTracking", function (
