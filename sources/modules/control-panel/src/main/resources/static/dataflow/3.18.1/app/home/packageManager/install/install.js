...
angular
  ...
  .controller('InstallModalInstanceController',
      ["$scope", "$rootScope", "$modalInstance", "libraryList", "withStageLibVersion", "api", "pipelineConstant", "$modal", "authService", function ($scope, $rootScope, $modalInstance, libraryList, withStageLibVersion, api, pipelineConstant, $modal,
        authService) {
