...
angular.module('pipelineGraphDirectives', [])
  ...
  .controller('PipelineGraphController', ["$scope", "$rootScope", "$element", "_", "$filter", "$location", "$modal", "pipelineConstant", "$translate", "$window", "pipelineService", "pipelineTracking", function(
    $scope, $rootScope, $element, _, $filter, $location, $modal,
    pipelineConstant, $translate, $window, pipelineService, pipelineTracking
  ) {
