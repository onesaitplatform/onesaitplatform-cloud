		...
		return (function() {
			...
			function error(title, message, optionsOverride) {
				return notify({
					...
					title: '<i style="color:#E87D7D" class="icon-error"></i>'+'&nbsp;&nbsp;&nbsp;'+ title
                });
			}
			...
			function info(title, message, optionsOverride) {
				if (typeof title === 'undefined' || title === null || title.length == 0) {
					...
					return notify({
						...
						message: message,
						optionsOverride: optionsOverride,
						title: '<i style="color:#9E9CC9" class="icon-info"></i>' + '&nbsp;&nbsp;&nbsp;' + title
					});
				}
			}
			...
			function success(title, message, optionsOverride) {
				return notify({
					...
					message: message,
					optionsOverride: optionsOverride,
					title: '<i style="color:#59C068" class="icon-check"></i>' + '&nbsp;&nbsp;&nbsp;' + title
				});
			}
			...
			function warning(title, message, optionsOverride) {
				return notify({
					...
					message: message,
					optionsOverride: optionsOverride,
					title: '<i style="color:#E79E38" class="icon-exclamation"></i>' + '&nbsp;&nbsp;&nbsp;' + title
				});
			}
