...
public class AuthenticationService {
	...
	public Authentication createAuthenticate(String engineName, String username, List<String> groupIds,
	...
	public Authentication createAuthenticate(ProcessEngine processEngine, String username, List<String> groupIds,
			List<String> tenantIds) {

		String userId = username;

		final User user = processEngine.getIdentityService().createUserQuery().userId(username).singleResult();
		...
		final UserAuthentication newAuthentication = new UserAuthentication(userId, processEngine.getName());
	...
	public List<String> getTenantsOfUser(ProcessEngine engine, String userId) {
		final List<Tenant> tenants = engine.getIdentityService().createTenantQuery().userMember(userId)
	...
	public List<String> getGroupsOfUser(ProcessEngine engine, String userId) {
		final List<Group> groups = engine.getIdentityService().createGroupQuery().groupMember(userId).list();
	...
	protected boolean isAuthorizedForApp(AuthorizationService authorizationService, String username,
