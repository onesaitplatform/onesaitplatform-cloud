...
public class HazelcastCacheLoaderConfig {
	...
	public HazelcastInstance defaultHazelcastInstanceEmbedded() throws IOException {
		...
		log.info("Configured Local Cache with data: Name : {}, Instance Name: {},  Group Name: {} ",
				configFile, config.getInstanceName(),config.getGroupConfig().getName());
	...
	public HazelcastInstance dockerHazelcastInstanceEmbedded() throws IOException {
		...
		log.info("Configured Local Cache with data: Name : {}, Instance Name: {},  Group Name: {} ",configFile, config.getInstanceName(),config.getGroupConfig().getName());
