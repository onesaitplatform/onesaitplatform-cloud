...
<html lang="en">
  <head>
	...
	<script src="https://lab.onesaitplatform.com/web/onesaitCesium/v2/api/onesaitCesium.js" type="module" defer="defer"></script>
    <!-- Load Turf library to allow some little GPs -->
    <script src="https://lab.onesaitplatform.com/web/onesaitCesium/v2/vendors/turf/turf.min.js"></script>
  ...
  <script type="module" defer="defer">/** GLOBAL VARIABLES */
/** LATEST **/
var intervalIds = [];
/** Set the initial extent. Change the values to set your own extent */
var startLongitude = -3.69
var startLatitude = 40.41
var startHeight = 6500
...
onesaitCesium.layers.loadBasemap({id:'esri.Streets.Labels.cs2',name:'esri.Streets.Labels.cs2',url:'https://services.arcgisonline.com/arcgis/rest/services/World_Street_Map/MapServer',type:'esri',unique: true}, map)
onesaitCesium.layers.loadIonAsset({code:'96188', id:'IonAssets', name:'IonAssets'}, map)
$("#intervalIds").val(JSON.stringify(intervalIds));
</script>
</body>
</html>
