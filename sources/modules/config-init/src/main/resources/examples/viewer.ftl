...
<html>
   ...
   <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
	...
	initialBaseMap('osm.Mapnik.Labels','', 'https://a.tile.openstreetmap.org/')
	loadWms('https://servicios.idee.es/wms-inspire/riesgos-naturales/inundaciones', 'NZ.Flood.MarinaT500', 'Inundaciones500')
	setInterval(function() {getLayerData('Supermarkets','[{"param":"company","type":"STRING","default":"mercadona"}]')}, 6000);
