...
public class ExpirationResetUsersQuartzConfig extends GenericQuartzConfig {

	private static final String SCHEDULER_BEAN_FACTORY_NAME = "expirationresetusers-scheduler-factory";

	@Bean(SCHEDULER_BEAN_FACTORY_NAME)
	public SchedulerFactoryBean expirationResetUsersSchedulerFactoryBean(JobFactory jobFactory,
			PlatformTransactionManager transactionManager) {
		return getSchedulerFactoryBean(jobFactory, transactionManager, true);
	}

	@Bean(SchedulerNames.EXPIRATION_RESET_USERS_NAME)
	public BatchScheduler expirationResetUsersScheduler(
	...
	public String getSchedulerBeanName() {
		return SchedulerNames.EXPIRATION_RESET_USERS_NAME;
	}
