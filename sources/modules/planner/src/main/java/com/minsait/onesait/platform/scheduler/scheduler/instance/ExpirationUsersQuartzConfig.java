...
public class ExpirationUsersQuartzConfig extends GenericQuartzConfig {

	private static final String SCHEDULER_BEAN_FACTORY_NAME = "expirationusers-scheduler-factory";

	@Bean(SCHEDULER_BEAN_FACTORY_NAME)
	public SchedulerFactoryBean expirationUsersSchedulerFactoryBean(JobFactory jobFactory,
			PlatformTransactionManager transactionManager) {
		return getSchedulerFactoryBean(jobFactory, transactionManager, true);
	}

	@Bean(SchedulerNames.EXPIRATION_USERS_NAME)
	public BatchScheduler expirationUsersScheduler(
	...
	public String getSchedulerBeanName() {
		return SchedulerNames.EXPIRATION_USERS_NAME;
	}
