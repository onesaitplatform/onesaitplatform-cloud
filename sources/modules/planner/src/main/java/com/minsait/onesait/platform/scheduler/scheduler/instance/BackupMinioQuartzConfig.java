...
public class BackupMinioQuartzConfig extends GenericQuartzConfig {

	private static final String SCHEDULER_BEAN_FACTORY_NAME = "backupminio-scheduler-factory";

	@Bean(SCHEDULER_BEAN_FACTORY_NAME)
	public SchedulerFactoryBean backupMinioSchedulerFactoryBean(JobFactory jobFactory,
			PlatformTransactionManager transactionManager) {
		return getSchedulerFactoryBean(jobFactory, transactionManager, true);
	}

	@Bean(SchedulerNames.BACKUP_MINIO_NAME)
	public BatchScheduler backupMinioScheduler(
	...
	public String getSchedulerBeanName() {
		return SchedulerNames.BACKUP_MINIO_NAME;
	}
