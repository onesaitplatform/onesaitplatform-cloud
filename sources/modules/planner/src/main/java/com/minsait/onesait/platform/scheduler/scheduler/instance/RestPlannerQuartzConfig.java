...
public class RestPlannerQuartzConfig extends GenericQuartzConfig {

	private static final String SCHEDULER_BEAN_FACTORY_NAME = "restplanner-scheduler-factory";
	...
	@Bean(SchedulerNames.REST_PLANNER_SCHEDULER_NAME)
	...
	public String getSchedulerBeanName() {
		return SchedulerNames.REST_PLANNER_SCHEDULER_NAME;
	}
