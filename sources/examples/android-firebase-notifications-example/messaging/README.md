Onesait - Firebase Cloud Messaging Quickstart Example
==============================

The app demonstrates registering an Android app for notifications and handling the receipt of a message.
...
Sending Notifications from onesait Platform
---------------------

Use onesait Platform as a central hub to send FCM messages to devices. To send a message you should use the Flow Engine module. In the palette you may find the onesaitplatform-firebase-notification node to connect to Firebase.
Find this link with a detailed how-to guide on this: - [onesait Platform Confluence post](https://stackoverflow.com/questions/tagged/firebase-cloud-messaging)
