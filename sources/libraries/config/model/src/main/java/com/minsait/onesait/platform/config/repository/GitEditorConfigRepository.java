...
public interface GitEditorConfigRepository extends JpaRepository<GitEditorConfig, String> {

	Optional<GitEditorConfig> findById(String id);
	
	List<GitEditorConfig> findAll();
	
	GitEditorConfig findByResourceId(String id);
