...
public interface SubscriptorRepository extends JpaRepository<Subscriptor, Long> {
	...
	public List<Subscriptor> findBySubscription(Subscription subscription);

	public Subscriptor findBySubscriptionId(String subscriptionId);

	public List<Subscriptor> findByClientId(String clientIdId);
}
