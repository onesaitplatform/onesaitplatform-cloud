...
@Configurable
@Entity
@Table(name = "TYPOLOGYDATASET")
public class ODTypologyDataset {
	...
	@Column(name = "TYPOLOGYID", length = 512)
	@Getter
	@NotNull
	@Setter
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ODTypologyDataset)) {
			return false;
		}
		ODTypologyDataset that = (ODTypologyDataset) o;
