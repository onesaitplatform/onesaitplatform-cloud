 ...
 */
package com.minsait.onesait.platform.persistence.opensearch.sql.connector;
...
public class OpenSearchSQLDbHttpImpl implements OpenSearchSQLDbHttpConnector {
	...
	public void init() {
		...
		final Map<String, Object> elasticsearch = (Map<String, Object>) database.get("opensearch");
