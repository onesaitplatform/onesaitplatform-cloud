...
import com.minsait.onesait.platform.persistence.opensearch.api.OSSearchService;
import com.minsait.onesait.platform.persistence.opensearch.api.OSUpdateService;
import com.minsait.onesait.platform.persistence.opensearch.sql.connector.OpenSearchSQLDbHttpImpl;
import com.minsait.onesait.platform.resources.service.IntegrationResourcesService;

import lombok.extern.slf4j.Slf4j;

@Component("OpenSearchBasicOpsDBRepository")
@Scope("prototype")
@Conditional(OpensearchEnabledCondition.class)
@Lazy
@Slf4j
public class OpenSearchBasicOpsDBRepository implements BasicOpsDBRepository {
	...
	@Autowired
	private OSCountService eSCountService;
	@Autowired
	private OSSearchService eSDataService;
	@Autowired
	private OSDeleteService eSDeleteService;
	@Autowired
	private OSInsertService eSInsertService;
	@Autowired
	private OSUpdateService eSUpdateService;
	@Autowired
	private OpenSearchSQLDbHttpImpl elasticSearchSQLDbHttpConnector;
	@Autowired
