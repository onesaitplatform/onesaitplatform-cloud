...
@Slf4j
public class JSONResultsetExtractorJSON implements ResultSetExtractor<List<JSONObject>> {
	...
	public JSONResultsetExtractorJSON(String statement, String originalStatement) {
		this.statement = statement;
		this.originalStatement = originalStatement;
		this.ontologyDataService = BeanUtil.getBean(OntologyDataService.class);
	}

	public JSONResultsetExtractorJSON(String statement, String originalStatement, boolean ignoreRelations) {
		this.statement = statement;
		this.originalStatement = originalStatement;
		this.ontologyDataService = BeanUtil.getBean(OntologyDataService.class);
