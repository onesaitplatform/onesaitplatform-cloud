...
public class UniqueKey {
	...
	public String generateSQL(String tableName) {
		final String ukName = "uk_" + tableName.replace(".", "_");
		switch (database) {
		case POSTGRES:
			return "ALTER TABLE " + tableName + " ADD CONSTRAINT " + ukName + " UNIQUE ("
					+ String.join(",", tableColumns) + ");";
		case MARIADB:
		default:
			return "ALTER TABLE " + tableName + " ADD UNIQUE (" + String.join(",", tableColumns) + ");";
		}
	}
