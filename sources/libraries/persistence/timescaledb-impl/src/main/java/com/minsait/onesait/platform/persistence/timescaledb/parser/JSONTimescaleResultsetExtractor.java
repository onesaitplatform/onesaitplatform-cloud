 ...
 */
package com.minsait.onesait.platform.persistence.timescaledb.parser;
...
@Slf4j
public class JSONTimescaleResultsetExtractor implements ResultSetExtractor<List<String>> {


	private String statement;

	public JSONTimescaleResultsetExtractor(String statement) {
