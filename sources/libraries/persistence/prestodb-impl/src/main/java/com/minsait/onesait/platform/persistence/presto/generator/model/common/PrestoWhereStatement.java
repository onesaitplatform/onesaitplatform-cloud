...
public class PrestoWhereStatement {
	@Size(min = 1)
	@NotNull
	...
	public PrestoWhereStatement(){}

	public PrestoWhereStatement(final String column, final String operator, final String value) {
		this.column = column;
		this.operator = operator;
		this.value = value;
	}

	public PrestoWhereStatement(final String column, final String operator, final String value, final String condition, final String function) {
		this.column = column;
		this.operator = operator;
		this.value = value;
