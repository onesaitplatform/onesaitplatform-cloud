...
public class PrestoInsertStatement implements PrestoSQLStatement {
	@NotNull
	@Size(min = 1)
	...
	public PrestoInsertStatement() {
	}

	public PrestoInsertStatement(final PrestoSQLGenerator sqlGenerator) {
	...
	public PrestoInsertStatement setOntology(final String ontology) {
	...
	public PrestoInsertStatement setValuesAndColumnsForInstances(final List<String> instances){
