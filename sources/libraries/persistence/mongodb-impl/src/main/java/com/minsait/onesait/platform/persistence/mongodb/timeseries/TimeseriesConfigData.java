...
public class TimeseriesConfigData {
	@Getter
	@Setter
	private Ontology ontologyStats; 
	@Getter
	@Setter
	private List<OntologyTimeSeriesProperty> properties; 
	@Getter
	@Setter
	private List<OntologyTimeSeriesWindow> windows; 
	@Getter
	@Setter
