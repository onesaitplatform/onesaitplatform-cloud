...
@Component("MindsDBBasicOpsDBRepository")
@Slf4j
public class MindsDBBasicOpsDBRepository implements BasicOpsDBRepository {

	private static final String NO_OP_CONTROL_ONTOLOGY = "MINDS DB ONTOLOGY";
