...
HOSTNAME = get_env('HOST', 'http://localhost:8087/dlabeling/')
if HOSTNAME:
...
DATABASES_ALL = {
    DJANGO_DB_POSTGRESQL: {
        ...
        'NAME': get_env('POSTGRE_NAME', 'onesaitplatform_datalabeling'),
    ...
    DJANGO_DB_MYSQL: {
        ...
        'NAME': get_env('MYSQL_NAME', 'onesaitplatform_datalabeling'),
