...
export default [
  ...
  },
  {
    ...
    tooltip: 'write the name of the datasource with which the selector data will be loaded.',
    conditional: {
      json: { '===': [{ var: 'data.dataSrc' }, 'datasource'] },
    },
  },
  {
    type: 'textfield',
    ...
    placeholder: 'Parameter to filter datasource',
    tooltip: 'write the parameter of the datasource by which it will be filtered.',
    conditional: {
      json: { '===': [{ var: 'data.dataSrc' }, 'datasource'] },
    },
  },
