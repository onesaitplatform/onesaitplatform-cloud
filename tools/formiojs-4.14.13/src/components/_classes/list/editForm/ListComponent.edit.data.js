export default [
    {
        ...
        input: true,
        weight: 0,
        tooltip: 'The source to use for the select data. Datasource obtains the data from a defined datasource, it is only necessary to write the identifier, and the path of the value and the description. Values lets you provide your own values and labels.  JSON lets you provide raw JSON data. URL lets you provide a URL to retrieve the JSON data from.',
        key: 'dataSrc',
        defaultValue: 'values',
