...
class Formio {
  ...
  static makeRequest(formio, type, url, method, data, opts) {//meter aqui seguridad
    if (!formio) {
  ...
  static request(url, method, data, header, opts) {
    ...
    if (window.authorization.access_token) {
      headers.append('Authorization', `Bearer ${window.authorization.access_token}`);
    }
    //headers.append('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..CCZziIIVz_D38T0YQvEttCzVF_1aDWDduGBWaIin-fs');
...
Formio.baseUrl = window.formsBaseURLCreate || 'http://localhost:18000/controlpanel/api/forms';
...
Formio.cdn = new CDN(window.urlLibraries);
