...
# onesaitplatform
# update the version
To update the version and not lose the changes, you would have to take the components that have been created or modified in this one, which are:
src/components/button
src/components/htmltable
src/components/select
src/components/TABLEPAG


after that add them to the builder.js and index.js files of the components folder
# pass the changes to the control panel
For the changes made here to be reflected in the platform, copy the contents of the dist folder to the onesait-cloud-platform/sources/modules/control-panel/src/main/resources/static/formsio/formiojs/dist folder
...
IMPORTANT for local develop install ruby and https://jekyllrb.com/
